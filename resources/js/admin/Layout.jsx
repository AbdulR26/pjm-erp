...
import { LayoutDashboard, UsersRound, LogOut, Car, Shield, Menu, X, Package, ShoppingCart, FolderTree, Tag, Warehouse, ChevronDown, Image, Settings, Ticket } from 'lucide-react';
...
export default function Layout({ user, currentTab, setTab, onLogout, children }) {
    ...
    const isCatalogActive = ['products', 'categories', 'attributes', 'stock'].includes(currentTab);
