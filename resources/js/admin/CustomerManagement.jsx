...
export default function CustomerManagement() {
    ...
    const handleDeleteCustomer = async (id) => {
        if (!window.confirm('Apakah Anda yakin ingin menghapus data customer ini secara permanen?')) return;
                    ...
                    <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl border border-slate-100 animate-in fade-in zoom-in-95 duration-200 overflow-hidden">
                        ...
                        <form onSubmit={handleFormSubmit} className="p-6 space-y-4 text-xs font-semibold text-slate-700">
                            ...
                            <div className="space-y-1">
                                ...
                                <textarea
                                    className={`w-full px-3.5 py-2.5 border rounded-xl font-medium focus:outline-hidden focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-slate-800 min-h-[80px] ${
