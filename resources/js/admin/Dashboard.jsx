...
export default function Dashboard({ user, setTab }) {
    ...
    return (
        <div className="space-y-8">
            {/* Greeting Header */}
            <div className="bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-800 rounded-2xl p-6 md:p-8 text-white shadow-lg relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-2">
                    <span className="bg-yellow-400 text-blue-900 text-[10px] font-black px-2.5 py-1 rounded-md uppercase tracking-wider">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white rounded-2xl p-5 border border-slate-200/60 shadow-xs flex items-center justify-between group hover:shadow-md transition">
                    ...
                    <div className="h-12 w-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center shadow-inner group-hover:scale-105 transition">
                        <UsersRound size={20} />
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl p-5 border border-slate-200/60 shadow-xs flex items-center justify-between group hover:shadow-md transition">
                    ...
                    <div className={`h-12 w-12 rounded-xl flex items-center justify-center shadow-inner group-hover:scale-105 transition ${
                        isAdmin ? 'bg-indigo-50 text-indigo-600' : 'bg-slate-100 text-slate-400'
                    }`}>
                        <Shield size={20} />
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            <button
                                ...
                                className="w-full flex items-center space-x-3 p-3 bg-blue-50/50 hover:bg-blue-50 text-blue-700 rounded-xl border border-blue-100/50 transition font-bold text-xs text-left cursor-pointer"
                            >
                                <PlusCircle size={16} />
                            ...
                            {isAdmin && (
                                <button
                                    ...
                                    className="w-full flex items-center space-x-3 p-3 bg-indigo-50/50 hover:bg-indigo-50 text-indigo-700 rounded-xl border border-indigo-100/50 transition font-bold text-xs text-left cursor-pointer"
                                >
                                    <Shield size={16} />
